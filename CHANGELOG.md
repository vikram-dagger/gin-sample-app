...
## [1.1.0] - 2025-05-14
### Added
- Delete book endpoint (`DELETE /api/books/{id}`) to allow removal of books by ID
- Associated controller method (`DeleteBook`) for handling book deletion in Gin
- Route and test cases for book deletion, including handling of non-existent book deletion
