...
## [1.1.0] - YYYY-MM-DD
### Added
- Implemented `DeleteBook` endpoint (`DELETE /api/books/{id}`) and corresponding handler.
- Added route for deleting a book by its ID.
- Created tests for the `DeleteBook` feature including deletion of existing books and handling of non-existent books.
